...
// get field
$thisfield = empty($_REQUEST['thisfield']) ? '' : $_REQUEST['thisfield'];
...
if (!empty($_POST['form_save'])) {
    ...
    $dataSubmit = [];
    array_push($dataSubmit, $_POST['form_diagnosis']);
    array_push($dataSubmit, $_POST['form_title']);

    echo "window.opener.document.getElementById('$thisfield').value = " .  js_escape(implode(", ", $dataSubmit)) .";\n";
                        ...
                        <div class="form-group clearfix" id="button-container">
                            <div class="col-sm-12 text-left position-override">
                                <div class="btn-group" role="group">
                                    <button type='submit' id="form_save" name='form_save' class="btn btn-primary btn-save" value='<?php echo xla('Save'); ?>'><?php echo xlt('Save'); ?></button>
