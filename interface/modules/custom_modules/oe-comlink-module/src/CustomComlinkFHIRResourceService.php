...
class CustomComlinkFHIRResourceService extends FhirServiceBase implements IPatientCompartmentResourceService
{
    /**
...
//    use FhirServiceBaseEmptyTrait;
    ...
    /**
     * @var CustomComlinkDataStore The in memory sample data store we use for data population with our module
     */
    private $dataStore;
    ...
    public function __construct($fhirApiURL = null)
    {
        ...
        $this->dataStore = new CustomComlinkDataStore();
    }

    /**
     * @param array $dataRecord
     * @param bool $encode
     * @return CustomComlinkFHIRResource|\OpenEMR\Services\FHIR\the
     */
    public function parseOpenEMRRecord($dataRecord = array(), $encode = false)
    {
        $fhirResource = new CustomComlinkFHIRResource();
