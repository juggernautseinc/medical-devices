...
class CustomComlinkRestController
{
    /**
     * @var CustomComlinkRestController
     */
    private $customComlinkResourceService;
    ...
    {
        $this->customComlinkResourceService = new CustomComlinkFHIRResourceService();
     ...
     */
    public function getOneResource($fhirId, HttpRestRequest $request) : CustomComlinkFHIRResource
    {
        if ($request->isPatientRequest()) {
            // only allow access to data of binded patient
    ...
    {
        $processingResult = $this->customComlinkResourceService->getAll($searchParams, $puuidBind);
        $bundleEntries = array();
        ...
        $bundleSearchResult = $this->fhirService->createBundle('CustomComlinkResource', $bundleEntries, false);
